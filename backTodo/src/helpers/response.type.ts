 ...
 * @typedef {object} ResponseApi
 * @property {HttpCode} status - stado de respuesta 
 * @property {object} data - objeto de respuesta
 */
 ...
 * @typedef {object} ResponseApi
 * @property {HttpCode} status - stado de respuesta 
 * @property {string} message - stado de respuesta 
 * @property {object} detailsError - objeto de respuesta
 */
